...
export default function Resume() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      period: "2018 - 2020",
      description: "Developed and maintained full-stack applications, improving performance and user experience."
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-4xl font-bold text-center text-white">Resume</h2>
            <motion.a
